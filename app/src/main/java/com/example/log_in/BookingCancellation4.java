...
public class BookingCancellation4 extends AppCompatActivity {
    ...
    private String selectedOption4; // Declare this variable at the class level


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_booking_cancellation4);
        ...
        spinRefund.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                selectedOption4 = parentView.getItemAtPosition(position).toString();
        ...
        detailsclick.setOnClickListener(v -> {
            Intent intent = new Intent(BookingCancellation4.this, BookingDetailMain.class);
        ...
        dialog = new Dialog(BookingCancellation4.this);
...
// Buttons for withdrawal dialog
        ...
        notnowbtn.setOnClickListener(v -> {
            Intent backIntent = new Intent(BookingCancellation4.this, BookingDetailMain4.class);
            startActivity(backIntent);
            Toast.makeText(BookingCancellation4.this, "Not now", Toast.LENGTH_SHORT).show();
            dialog.dismiss();
        });

// CONFIRMATION BUTTON, NAVIGATE TO THE BOOKING DETAIL MAIN
        confirmbtn.setOnClickListener(v -> {
            Intent confirmIntent = new Intent(BookingCancellation4.this, BookingDetailMain4.class);
...
// Initialization and actions for continue dialog
        ...
        btnNotnow.setOnClickListener(v -> {
            Intent notnowIntent = new Intent(BookingCancellation4.this, BookingDetailMain4.class);
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            Toast.makeText(BookingCancellation4.this, "Confirm Cancellation, please wait for approval", Toast.LENGTH_SHORT).show();
            dialog.dismiss();
        });
    ...
    private void saveSelectedOptionToFirestore() {
        ...
        if (currentUser != null) {
            userDocRef
                    .update("selectedRefundOption4", selectedOption4)
        ...
        userDataListener = db.collection("users")
                ...
                .addSnapshotListener((documentSnapshot, error) -> {
                    ...
                    if (documentSnapshot != null && documentSnapshot.exists()) {
                        String selectedTour4 = documentSnapshot.getString("selectedTour4");
                        String E_mail = documentSnapshot.getString("Email");
                        String selectedOption4 = documentSnapshot.getString("selectedRefundOption4");
                        double total4= documentSnapshot.getDouble("totalAmount4");
                        // Use getDouble for numeric values
                        String selectedTouristNum4 = documentSnapshot.getString("selectedTouristNum4");

                        // Check if the views are not null before setting values
                        if (TotalTouristsText != null) {
                            TotalTouristsText.setText(selectedTouristNum4);
                        }
                        if (amountText != null) {
                            amountText.setText(String.format("₱%.2f", total4));
                        }

                        if (pickhouseText != null) {
                            pickhouseText.setText(selectedTour4);
                        }
                        if (nameText != null) {
    ...
    private void saveOptionToFirestore() {
        ...
        if (currentUser != null) {
            userDocRef
                    .update("selectedRefundOption4", selectedOption4)  // Update the selected refund option in Firestore
                    .addOnSuccessListener(aVoid -> {
                        // Show a toast message indicating that the option has been saved successfully
                        //Toast.makeText(BookingCancellation.this, "Selected refund option saved successfully", Toast.LENGTH_SHORT).show();
                    })
